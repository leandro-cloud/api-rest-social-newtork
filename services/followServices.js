...
// Obtenemos el array de usuarios que yo sigo y que me siguen
...
// Obtenemos los datos de un usuario que me esta siguiendo a mi o que yo sigo
export const followThisUser = async (identityUserId, profileUserId) => {
  try {
    // Verificar si los IDs son validos
    if (!identityUserId || !profileUserId) {
      throw new Error('IDs de los usuariosson invalidos')
    }
    ...
    // Consultar si el otro usuario (profileUserId) me sigue a mi o al usuario autenticado (identytyUserId)
